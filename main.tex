...
\begin{enumerate}
  \item The flow controllers were rewired to reduce the 15-pin connectors coming
    from the Aalborg connectors to 9-pin connectors before being
    wired into the NI
    DAC. Refer to \Cref{fig: DB15 to DB9 connector diagram} and
    \Cref{tab: flow controller wiring}.
...
\begin{figure}[H]
  ...
  \caption{A wiring diagram showing the DB15 to DB9 wiring connections for the
    ...
    shown in brown, and
  ground is tied to the negative pole of the 24V power supply.}
...
\begin{table}[H]
  ...
  \begin{tabular}{llll}
    ...
    - & 15 & \color{black}none & Chassis ground \\
    \hline
  \end{tabular}
