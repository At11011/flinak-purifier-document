...
full and proper function. One of the first failures was an accidental ingress
...
failures of the purifier are covered in \Cref{chap: failure report}. \par
...
operational history (\Cref{chap: operational history}), failure reports 
(\Cref{chap: failure report}), and important details on the equipment 
