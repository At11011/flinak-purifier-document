...
Another available method for molten salt purification is \ch{NH4HF2} baking. This 
...
\begin{figure}
    ...
    \caption{Molten salt electrolytic purification vessel design used by Zuo el al.}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{./assets/review/figures/chloride electrocell.pdf}
...
\begin{figure}
    ...
    \caption{Ellingham diagram of the expected redox window from Carotti et al \cite{rev48}.}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{./assets/review/figures/fluorides gibbs energy.pdf}
    \caption{Gibbs Free Energy of Fluorination of Various Elemental Metals \cite{rev33}.}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{./assets/review/figures/h2 embrittlement.jpg}
    \caption{Microstructure of annealed 316L stainless steel before (a) and after (b) 20 hr of cathodic
hydrogen charging compared to annealed Hastelloy C-276 before (c) and after (d) \SI{20}{\hour} of cathodic
hydrogen charging. \cite{rev53}}
\label{fig: h2 embrittlement}
\end{figure}

This increase in crack size and frequency in higher Ni alloys would likely allow for more surface to be
attacked by corrosive agents; however, the higher Ni content likely more than offsets this through its
