...
(\ch{NaZrF5}), requiring longer sparge times \cite{rev7,rev8}.
In 1959, tests using molten ammonium bifluoride (\ch{NH4HF2}) showed
that it performs an adequate job of converting metal oxides into
fluorides, making it a
...
period of fueled operation \cite{rev10,rev11}. \par
...
has a melting point of \SI{459}{\celsius} \cite{rev16,rev17}.
